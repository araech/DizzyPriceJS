...
const Items36  = {
    spellbooks: [
        ["dig",             "parchment",   20, 500],
        ["magic missile",   "vellum",      45, 200],
        ["fireball",        "ragged",      20, 400],
        ["cone of cold",    "dog eared",   10, 400],
        ["sleep",           "mottled",     50, 100],
        ["finger of death", "stained",      5, 700],
        ["light",           "cloth",       45, 100],
        ["detect monsters", "leathery",    43, 100],
        ["healing",         "white",       40, 100],
        ["knock",           "pink",        35, 100],
        ["force bolt",      "red",         35, 100],
        ["confuse monster", "orange",      30, 200],
        ["cure blindness",  "yellow",      25, 200],
        ["drain life",      "velvet",      10, 200],
        ["slow monster",    "light green", 30, 200],
        ["wizard lock",     "dark green",  30, 200],
        ["create monster",  "turquoise",   35, 200],
        ["detect food",     "cyan",        30, 200],
        ["cause fear",      "light blue",  25, 300],
        ["clairvoyance",    "dark blue",   15, 300],
        ["cure sickness",   "indigo",      32, 300],
        ["charm monster",   "magenta",     20, 300],
        ["haste self",      "purple",      33, 300],
        ["detect unseen",   "violet",      20, 300],
        ["levitation",      "tan",         20, 400],
        ["extra healing",   "plaid",       27, 300],
        ["restore ability", "light brown", 25, 400],
        ["invisibility",    "dark brown",  25, 400],
        ["detect treasure", "gray",        20, 400],
        ["remove curse",    "wrinkled",    25, 300],
        ["magic mapping",   "dusty",       18, 500],
        ["identify",        "bronze",      20, 300],
        ["turn undead",     "copper",      16, 600],
        ["polymorph",       "silver",      10, 600],
        ["teleport away",   "gold",        15, 600],
        ["create familiar", "glittering",  10, 600],
        ["cancellation",    "shining",     15, 700],
        ["protection",      "dull",        18, 100],
        ["jumping",         "thin",        20, 100],
        ["stone to flesh",  "thick",       15, 300],
        ["blank paper",     "plain",       18, 0]
    ],

    wands: [
        ["light",                   "glass", 95, 100],
        ["secret door detection",   "balsa", 50, 150],
        ["enlightenment",         "crystal", 15, 150],
        ["create monster",          "maple", 45, 200],
        ["wishing",                  "pine",  5, 500],
        ["nothing",                   "oak", 25, 100],
        ["striking",                "ebony", 75, 150],
        ["make invisible",         "marble", 45, 150],
        ["slow monster",              "tin", 50, 150],
        ["speed monster",           "brass", 50, 150],
        ["undead turning",         "copper", 50, 150],
        ["polymorph",              "silver", 45, 200],
        ["cancellation",         "platinum", 45, 200],
        ["teleportation",         "iridium", 45, 200],
        ["opening",                  "zinc", 25, 150],
        ["locking",              "aluminum", 25, 150],
        ["probing",               "uranium", 30, 150],
        ["digging",                  "iron", 55, 150],
        ["magic missile",           "steel", 50, 150],
        ["fire",                "hexagonal", 40, 175],
        ["cold",                    "short", 40, 175],
        ["sleep",                   "runed", 50, 175],
        ["death",                    "long",  5, 500],
        ["lightning",              "curved", 40, 175]
    ],

    potions: [
        ["gain ability",           "ruby", 42, 300],
        ["restore ability",        "pink", 40, 100],
        ["confusion",            "orange", 42, 100],
        ["blindness",            "yellow", 40, 150],
        ["paralysis",           "emerald", 42, 300],
        ["speed",            "dark green", 42, 200],
        ["levitation",             "cyan", 42, 200],
        ["hallucination",      "sky blue", 40, 100],
        ["invisibility", "brilliant blue", 40, 150],
        ["see invisible",       "magenta", 42,  50],
        ["healing",          "purple-red", 57, 100],
        ["extra healing",          "puce", 47, 100],
        ["gain level",            "milky", 20, 300],
        ["enlightenment",        "swirly", 20, 200],
        ["monster detection",    "bubbly", 40, 150],
        ["object detection",      "smoky", 42, 150],
        ["gain energy",          "cloudy", 42, 150],
        ["sleeping",       "effervescent", 42, 100],
        ["full healing",          "black", 10, 200],
        ["polymorph",            "golden", 10, 200],
        ["booze",                 "brown", 42,  50],
        ["sickness",              "fizzy", 42,  50],
        ["fruit juice",            "dark", 42,  50],
        ["acid",                  "white", 10, 250],
        ["oil",                   "murky", 30, 250],
        ["(un)holy water",        "clear", 92, 100]
    ],
...
const Items37 = {
    ...
    stones: [
        ["luckstone", "gray stone", 10, 60],
        ["loadstone", "gray stone", 10, 1],
        ["touchstone", "gray stone", 8, 45],
        ["flint", "gray stone", 10, 1]
    ],
    weapons: [
        ["arrow", "", 55, 2],
        ["elven arrow", "runed arrow", 20, 2],
